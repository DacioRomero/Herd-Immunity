...
h
    ...
    def __init__(self, population_size, vacc_percentage, virus_name,
        ...
        # TODO: Create a Logger object and bind it to self.logger. You should
        #   use this logger object to log all events of any importance during
        #   the simulation. Don't forget to call these logger methods in the
        #   corresponding parts of the simulation!
        self.logger = None

        # This attribute will be used to keep track of all the people that
        # catch the infection during a given time step. We'll store each newly
        # infected person's .ID attribute in here. At the end of each time
        # step, we'll call self._infect_newly_infected() and then reset
        # .newly_infected back to an empty list.
        self.newly_infected = []
    ...
    def _create_population(self, initial_infected):
        ...
        while len(population) != pop_size:
            if infected_count != initial_infected:
                ...
                # about the rest. Don't forget to increment infected_count
                # every time you create a new infected person!
                pass
            else:
                # Now create all the rest of the people.
                # Every time a new person will be created, generate a random
                # number between 0 and 1. If this number is smaller than
                # vacc_percentage, this person should be created as a
                # vaccinated person. If not, the person should be created as an
                # unvaccinated person.
                pass
            # TODO: After any Person object is created, whether sick or
            # healthy, you will need to increment self.next_person_id by 1.
            # Each Person object's ID has to be unique!
        return population

    def _simulation_should_continue(self):
        # TODO: Complete this method!  This method should return True if the
        # simulation should continue, or False if it should not. The
        # simulation should end under any of the following circumstances:
    ...
    def run(self):
        # TODO: Finish this method. This method should run the simulation
        # until everyone in the simulation is dead, or the disease no longer
        # exists in the population. To simplify the logic here, we will use the
        # helper method _simulation_should_continue() to tell us whether or not
        # we should continue the simulation and run at least 1 more time_step.
        ...
        # remember to the logger's log_time_step() method at the end of each
        # time step, pass in the time_step_counter variable!
        time_step_counter = 0
        ...
        while should_continue:
            ...
            # compute anotherround of this simulation. At the end of each
            # iteration of this loop, remember to rebind should_continue to
            # another call of self._simulation_should_continue()!
            pass
        print('The simulation has ended after {time_step_counter} turns.
              .format(time_step_counter))

    def time_step(self):
        # TODO: Finish this method!  This method should contain all the basic
        # logic for computing one time step in the simulation. This includes:
        ...
        #                with dead people, this does not count as an
        #               interaction.
        #           - Else:
    ...
    def interaction(self, person, random_person):
        # TODO: Finish this method! This method should be called any time two
        # living people are selected for an interaction. That means that only
        # living people should be passed into this method. Assert statements
        # are included to make sure that this doesn't happen.
        ...
        #       smaller than basic_repro_num, random_person's ID should be
        #       appended to Simulation object's newly_infected array, so that
        #       their .infected attribute can be changed to True at the end of
        #       the time step.
        # TODO: Remember to call self.logger.log_interaction() during this
        #   method!
        pass

    def _infect_newly_infected(self):
        # TODO: Finish this method! This method should be called at the end of
        # every time step. This method should iterate through the list stored
        # in self.newly_infected, which should be filled with the IDs of every
        # person created. Iterate though this list.
        # For every person id in self.newly_infected:
        #   - Find the Person object in self.population that has this
        #       corresponding ID.
