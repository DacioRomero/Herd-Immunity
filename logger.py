class Logger(object):
    ...
    def write_metadata(self, pop_size, vacc_percentage, virus_name,
        ...
        # TODO: Finish this method.  The simulation class should use this
        # method immediately upon creation, to log the specific parameters of
        # the simulationas the first line of the file.  This line of metadata
        # should be tab-delimited (each item separated by a '\t' character).
        # NOTE: Since this is the first method called, it will create the text
        # file that we will store all logs in.  Be sure to use 'w' mode when
        # you open the file. For all other methods, we'll want to use the 'a'
        # mode to append our new log to the end, since 'w' overwrites the file.
    ...
    def log_interaction(self, person1, person2, did_infect=None,
        ...
        # method to log every interaction a sick individual has during each
        # time step. This method should accomplish this by using the
        # information from person1 (the infected person), person2 (the person
        # randomly chosen for the interaction), and the optional keyword
        # arguments passed into the method.  See documentation for more info
